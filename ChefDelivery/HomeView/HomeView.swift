        ...
        GeometryReader { geometry in
            ZStack {
                Circle()
                    ...
                    .frame(width: isAnimating ? 400 : 420)
                    .position(x: isAnimating ? 50 : 23,
                              y: isAnimating ? 100 : geometry.size.height / 2)
                    .blur(radius: 100)
                ...
                Circle()
                    ...
                    .frame(width: isAnimating ? 400 : 420)
                    .position(
                        x: isAnimating ? geometry.size.width - 50 : geometry.size.width / 2,
                        y: isAnimating ? geometry.size.height - 50 : geometry.size.height / 2
                    )
                    .blur(radius: 100)
                    .opacity(isAnimating ? 0.5 : 0.5)
                    .animation(Animation.easeInOut(duration: 5).repeatForever(autoreverses: true))
